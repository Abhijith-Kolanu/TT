    ...
    <div className='flex w-full min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200'>
      ...
      */}
      ...
      {/* 
        ...
        Hide it on the Messages page for a cleaner chat experience
      */}
      ...
      {/* 
        ...
        On Messages page, we don't add right margin since RightSidebar is hidden
      */}
      <main className={`flex-1 lg:ml-64 ${!isMessagesPage ? 'xl:mr-72' : ''} overflow-y-auto`}>  
        {/* 
        ...
        */}
        <div className='p-4 min-h-full'> {/* Add some padding for content */}
          <Outlet />
        </div>
      </main>
