                ...
                <Popup minWidth={220}>
                  <div style={{ width: 220 }}>
                    ...
                    <div style={{ marginTop: 8 }}>
                      <div style={{ fontWeight: 700, fontSize: 13 }}>{post.locationName || post.location?.name || "Unknown place"}</div>
                      {post.caption && <div style={{ fontSize: 13, color: "#333", marginTop: 6 }}>{post.caption}</div>}
                    </div>
                  </div>
                </Popup>
              </Marker>
